...
# ── Paths ──────────────────────────────────────────────────────────────────────
RAW_TEMPLATE     = "../raw_templates/T2/RXAndMRTemplate.pdf"
TEXTBOX_TEMPLATE = "../templates_with_textboxes/T2/RXAndMRTemplate.pdf"
FILLED_OUTPUT    = "./test_files/T2_RXAndMRTemplate_filled_test.pdf"

os.makedirs("./test_files", exist_ok=True)

# ── Step 1: Create template with textboxes ─────────────────────────────────────
print("Step 1: Creating template with textboxes...")
template = t2_rx_mr_template(RAW_TEMPLATE)
