...
template = t0_rx_mr_template("../raw_templates/T0/RXAndMRTemplate.pdf")
...
template.create_textbox("MotusProduct", 1, 338, 376, 69)
template.create_textbox("PatientName", 1, 430, 376, 180)
template.create_textbox("PatientDOB", 1, 100, 391, 78)
template.create_textbox("DocName", 1, 205, 391, 200)

# Save
template.save_pdf("../templates_with_textboxes/T0/RXAndMRTemplate.pdf")