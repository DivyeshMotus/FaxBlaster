...
# ── Paths ──────────────────────────────────────────────────────────────────────
RAW_TEMPLATE     = "../raw_templates/T1/RXAndMRTemplate.pdf"
TEXTBOX_TEMPLATE = "../templates_with_textboxes/T1/RXAndMRTemplate.pdf"
FILLED_OUTPUT    = "./test_files/T1_RXAndMRTemplate_filled_test.pdf"

os.makedirs("./test_files", exist_ok=True)

# ── Step 1: Create template with textboxes ─────────────────────────────────────
print("Step 1: Creating template with textboxes...")
template = t1_rx_mr_template(RAW_TEMPLATE)
...
template.create_textbox("MotusProduct", 1, 339, 379, 69)
template.create_textbox("PatientName",  1, 425, 379, 180)
