...
# ── Paths ──────────────────────────────────────────────────────────────────────
RAW_TEMPLATE     = "../raw_templates/T1/MRTemplate.pdf"
TEXTBOX_TEMPLATE = "../templates_with_textboxes/T1/MRTemplate.pdf"
FILLED_OUTPUT    = "./test_files/T1_MRTemplate_filled_test.pdf"

os.makedirs("./test_files", exist_ok=True)

# ── Step 1: Create template with textboxes ─────────────────────────────────────
print("Step 1: Creating template with textboxes...")
template = t1_mr_template(RAW_TEMPLATE)
...
template.create_textbox("MotusProduct", 1, 244, 393.5, 67)
template.create_textbox("PatientName",  1, 340, 393.5, 200)
template.create_textbox("PatientDOB",   1, 100, 408, 78)
template.create_textbox("DocName",      1, 205, 408, 200)
