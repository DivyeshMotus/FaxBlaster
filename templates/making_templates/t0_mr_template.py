...
# ── Paths ──────────────────────────────────────────────────────────────────────
RAW_TEMPLATE     = "../raw_templates/T0/MRTemplate.pdf"
TEXTBOX_TEMPLATE = "../templates_with_textboxes/T0/MRTemplate.pdf"
FILLED_OUTPUT    = "./test_files/T0_MRTemplate_filled_test.pdf"

os.makedirs("./test_files", exist_ok=True)

# ── Step 1: Create template with textboxes ─────────────────────────────────────
print("Step 1: Creating template with textboxes...")
template = t0_mr_template(RAW_TEMPLATE)
...
template.create_textbox("MotusProduct", 1, 242, 393.5, 67)
template.create_textbox("PatientName",  1, 325, 393.5, 200)
