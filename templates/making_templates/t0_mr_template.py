...
template = t0_mr_template("../raw_templates/T0/MRTemplate.pdf")
...
template.create_textbox("MotusProduct", 1, 242, 390, 67)
template.create_textbox("PatientName", 1, 325, 390, 200)
template.create_textbox("PatientDOB", 1, 100, 405, 78)
template.create_textbox("DocName", 1, 205, 405, 200)

# Save
template.save_pdf("../templates_with_textboxes/T0/MRTemplate.pdf")