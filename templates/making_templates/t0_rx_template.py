...
# ── Paths ──────────────────────────────────────────────────────────────────────
RAW_TEMPLATE     = "../raw_templates/T0/RXTemplate.pdf"
TEXTBOX_TEMPLATE = "../templates_with_textboxes/T0/RXTemplate.pdf"
FILLED_OUTPUT    = "./test_files/T0_RXTemplate_filled_test.pdf"

os.makedirs("./test_files", exist_ok=True)

# ── Step 1: Create template with textboxes ─────────────────────────────────────
print("Step 1: Creating template with textboxes...")
template = t0_rx_template(RAW_TEMPLATE)
template.create_textbox("Date",        1, 100, 190, 100)
template.create_textbox("To",          1, 90,  219, 100)
template.create_textbox("FaxNumber",   1, 139, 248.5, 100)
